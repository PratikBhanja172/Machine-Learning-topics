...
Original file is located at
    https://colab.research.google.com/drive/1IkKbUUjjUOp-RUVgjEnLTEVc64eKxIU0
"""
...
ax.scatter(X_test, [0]*len(X_test), y_test, color='blue', label='Actual')
ax.scatter(X_test, [0]*len(X_test), y_pred, color='red', label='Predicted')
